...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  for (const appliedDiscount of discountCodes) {
    ...
    // Pre-compute tags and metafields to avoid duplication
    ...
    try {
      ...
      console.error("[webhook] Error pre-computing tags and metafields:", e);
    }
        ...
        await prisma.$transaction(async (tx) => {
          ...
          await tx.processedOrder.create({
            data: {
              ...
              discountCode: freshRecord.discountCode,
              discountType: freshRecord.discountType,
              discountValue: freshRecord.discountType === "fixed" ? freshRecord.fixedValue : freshRecord.percentage,
              discountCategory: freshRecord.discountCategory,
              discountProductCategory: productMetafields.size > 0 ? JSON.stringify(Array.from(productMetafields)) : null,
              paymentType: freshRecord.paymentType,
            },
          });
